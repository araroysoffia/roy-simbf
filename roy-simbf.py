...
def settua():
	...
	if ask =="":
		...
		try:
			...
			save.write(ua) 
			save.close()
			print(" \033[0;97m[\033[0;92mâœ“\033[0;97m] Successfully Setting User-Agent")
			time.sleep(2)
			menu()
		...
		try:
			...
			save.write(ua) 
			save.close()
			print("\n \033[0;97m[\033[0;92mâœ“\033[0;97m] Successfully Setting User-Agent")
			time.sleep(2)
			menu()
		except KeyboardInterrupt:
			exit()
